...
<head>
    ...
    <title>Profile | <?php echo htmlentities($data["firstname"])." ".htmlentities($data["lastname"]); ?></title>
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <div class="list-unstyled components">
                <center><p><?php echo htmlentities($data["firstname"])." ".htmlentities($data["lastname"]); ?></p>
                <?php
